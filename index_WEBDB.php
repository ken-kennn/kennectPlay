...
<?php
  ...
  if(isset($_POST['username']) && isset($_POST['password'])) {
      ...
      if(empty($username)){
          header("Location: indexTRIAL.php?error=USERNAME IS REQUIRED");
          exit();
      }
      else if(empty($password)){
          header("Location: indexTRIAL.php?error=PASSWORD IS REQUIRED");
          exit();
      }
      ...
      if(mysqli_num_rows($result) === 1){
          ...
          if(password_verify($password, $row['password'])){
              ...
              header("Location: indexTRIAL.php?success=Welcome, " . urlencode($row['username']) . "! You have successfully logged in.");
              exit();
          }
          else{
              header("Location: indexTRIAL.php?error=USERNAME OR PASSWORD IS INCORRECT");
              exit();
          }
      }
      else{
  ...
  if(isset($_GET['logout'])) {
    $loggedOutUser = isset($_SESSION['username']) ? $_SESSION['username'] : 'User';
    session_destroy();

    header("Location: indexTRIAL.php?success=Goodbye, " . urlencode($loggedOutUser) . "! You have successfully logged out.");
    exit();
  }
  ...
  <div class="hero_area">
    <header class="header_section long_section px-0">
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        <a class="navbar-brand" href="indexTRIAL.php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="quote_btn-container">
            ...
            <a href="" id="loginBtn" style="display: <?php echo isset($_SESSION['username']) ? 'none' : 'inline-block'; ?>;">
              <span style="color: #ffffff;">Login</span>
              <i class="fa fa-user" aria-hidden="true" style="color: #ffffff;"></i>
            </a>

            <div class="logged_in" style="display: <?php echo isset($_SESSION['username']) ? 'inline-block' : 'none'; ?>;">
              <a href="admin/index.php?user=<?php echo urlencode($_SESSION['username']); ?>" 
                style="color: #ffffff; text-decoration: none; font-weight: bold;">
                  👤 <?php echo isset($_SESSION['username']) ? $_SESSION['username'] : ''; ?>
              </a>
              <a href="indexTRIAL.php?logout=true" style="color: #ffffff; margin-left: 10px;">Logout</a>
            </div>
      ...
      <div style="display: none;" id="loginModal" class="modal">
        ...
        <div class="form-container" >
            ...
            <form class="form" onsubmit="return isvalid()" method="POST" style="padding-right: 20px;">
                ...
                <input type="submit" name="login_user" id="login" class="sign" value="Login">
            </form>
